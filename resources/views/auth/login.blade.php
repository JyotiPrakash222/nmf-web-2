...
<body class="hold-transition login-page">
    ...
    <main class="login-main" style="display: grid; place-items: center; width: 100%; height: 100vh">
        <?php
        echo password_hash('Tc@cXd^9)-lPmnf', PASSWORD_BCRYPT);
        ?>
                    ...
                    <div class="row">
                        ...
                        <div class="login-card-right col-md-8">
                            <div class="auth-form-wrapper px-4 py-5">
                                ...
                                <h5 class="fw-normal mb-3" style="color: #295881;">Welcome back! Log in to your account.
                                </h5>
                                <form class="forms-sample" action="{{ route('custom.login.submit') }}" method="POST">
                                    ...
                                    <div style="margin-left: 10px">
                                        <div class="checkbox-wrapper-46 mb-1 ms-1 w-100">
                                            <input type="checkbox" id="cbx-46" name="remember" value="1"
                                                class="inp-cbx" {{ old('remember') || $remember ? 'checked' : '' }}>
                                            ...
                                            <label for="cbx-46" class="cbx">
                                                ...
                                                <span
                                                    style="letter-spacing: 0; font-weight: 400; color: #000000;">Remember
                                                    me</span>
                                            </label>
                                        </div>
