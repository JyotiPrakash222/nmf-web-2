...
@php
    ...
    if ($video->video_path && $video->clip_file_name && strpos($video->video_path, 'file') !== false) {
        ...
        //$videoUrl = asset($folderPath . '/' . $video->clip_file_name); 
	$videoUrl = config('global.base_url_short_videos') . $folderPath . '/' . $video->clip_file_name;
        ...
        //$videothumb = asset($thumbFolder . '/' . $video->thumb_image); 
...
<head>
  ...
  <!-- Open Graph / Facebook -->
    ...
    <meta property="og:description" content="{{ $videos[$currentIndex]->description ?? 'Watch this short video on NMF News' }}">
    ...
    <meta name="twitter:description" content="{{ $videos[$currentIndex]->description ?? 'Watch this short video on NMF News' }}">
...
<body class="body-main">
        ...
        <div class="video-container">
            ...
            <div id="reelshare-modal" class="reelshare-modal">
                <div class="reelshare-modal-content">
                    {{-- <span class="reelshare-close" onclick="closeReelShareModal()">&times;</span> --}}
                    <!-- WhatsApp Share -->
            ...
            <div class="video-overlay-bottom">
                <div class="video-info">
                    ...
                    {{-- <div class="video-desc">{{ $videos[$currentIndex]->description }}</div> --}}
            ...
            <div class="video-actions">
                <button class="action-btn" onclick="openReelShareModal()" aria-label="Copy Link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"
                        fill="white">
                        <path d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7a2.5
                 2.5 0 000-.88l7.05-4.11A2.993 2.993 0 0018
                 7.91a3 3 0 10-2.83-2.12l-7.05 4.11a3.003
                 3.003 0 100 4.22l7.05 4.11A3 3 0
                 1018 16.08z"></path>
                    </svg>
                </button>
                {{-- Mute / Unmute --}}
    ...
    <script>
        (function() {
            ...
            // ^ excludes Edge, Opera, Samsung Internet, etc. and iOS Chrome (CriOS)
    ...
    <script>
        function navigateTo(cat, name) {
            ...
            if (video) {
                ...
                }, 300); // delay matches fade duration
            } else {
                window.location.href = `/short-videos/${cat}/${name}`;
            }
        }
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const video = document.getElementById("videoPlayer");
            const iconPath = document.getElementById("muteIconPath"); // your <path> in SVG
